...
class SQLAlchemyPodcastRepository(PodcastRepositoryInterface):
    ...
    def get_episodes_pending_transcription(
        ...
        @returns List[Episode]: Episodes with download_status == "completed",
        transcript_status == "pending" or ("processing" with provider == "scribe"),
        and a non-null local_file_path, ordered by published_date descending and limited to the provided `limit`.
        """
